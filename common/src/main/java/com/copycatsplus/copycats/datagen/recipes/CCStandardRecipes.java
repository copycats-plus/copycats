...
public class CCStandardRecipes extends CopycatsRecipeProvider {
    ...
    GeneratedRecipe COPYCAT_CHAINING_DOOR = copycat(CCBlocks.COPYCAT_CHAINING_DOOR, 2);

    GeneratedRecipe COPYCAT_CHAINING_SLIDING_DOOR = copycat(CCBlocks.COPYCAT_CHAINING_SLIDING_DOOR, 2);
