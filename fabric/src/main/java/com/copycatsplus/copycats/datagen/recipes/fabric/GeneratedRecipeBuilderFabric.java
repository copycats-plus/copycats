...
public class GeneratedRecipeBuilderFabric implements GeneratedRecipeBuilder {
    ...
    private final List<ConditionJsonProvider> recipeConditions = new ArrayList<>();
    private String path = "";
    ...
    public GeneratedRecipeBuilderFabric(String path, Supplier<? extends ItemLike> result) {
        this(path);
        this.result = result;
    }

    public GeneratedRecipeBuilderFabric(String path, ResourceLocation result) {
        this(path);
    ...
    public class GeneratedCookingRecipeBuilderFabric implements GeneratedCookingRecipeBuilder {
        ...
        GeneratedCookingRecipeBuilderFabric(Supplier<Ingredient> ingredient) {
    ...
    public class GeneratedStoneCuttingRecipeBuilderFabric implements GeneratedStoneCuttingRecipeBuilder {

        private final Supplier<Ingredient> ingredient;

        GeneratedStoneCuttingRecipeBuilderFabric(Supplier<Ingredient> ingredient) {
            this.ingredient = ingredient;
        }
