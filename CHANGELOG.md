...
- Fixed the null crash coming from materials being null. Fixing [Issue #423](https://github.com/copycats-plus/copycats/issues/423)
...
- Actually fixed the null issue with the config. It will no longer cause a crash

## 3.0.6 - 2026-02-15

### Fixed

- Interaction crashing bug

## 3.0.5 - 2026-02-15

### Added

- Support for Create Fabric 6.0.7+
